...
public enum ResultCodeEnum {
    ...
    EXCLUSIVE_HAVE_PRODUCT(1220, "商品已经绑定在新人专享中"),
    //关于用户401000起步
    ...
    ORDER_ITEM_QUANTITY(7004,"订单中商品数量不能小于1!"),
    ...
    BARGAIN_DOWN(203005, "砍价商品已下架或未开始"),
    ...
    NEW_USER(203021, "新用户参与的砍单啦，老用户就别来了吧！"),
    OLD_USER(203022, "只能老用户参加哦"),
    MEMBER_USER(203023, "只能社员参加哦"),
    GOODS_MAX_NUM(203024, "商品砍单次数上限了，换个号试试！"),
    DAY_MAX_NUM(203025, "当天砍单次数上限了，明天再来吧！"),
    WITHDRAW_CONFIRM_FAIL(400001, "提现处理失败,请重试!"),
    PAYENT_ERROR(400002,"转帐发起失败!"),

    //海报异常
    POSTER_ERROR(700001,"生成海报失败!"),
    //添加每日尖货异常
    ADD_TOPGOODS_ERROR(800001,"已有上架、未删除的每日尖货信息"),
    //添加每日尖货异常
    ADD_HOT_ERROR(800002,"已有上架、未删除的爆款信息"),
    //添加每日尖货异常
    ADD_FLAGSHIO_ERROR(800003,"已有上架、未删除的百荷旗舰信息");
    ;
